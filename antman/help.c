...
** B-PSU-100-BAR-1-1-antman-joan-pau.merida-ruiz
** File description:
** help
*/
...
int help(int ac, char **av)
{
    if (ac == 2 && my_strcmp(av[1], "-h") == 0) {
        my_putstr("USAGE\n");
        my_putstr("    ./antman [path_file] [type_file]\n\n");
        my_putstr("DESCRIPTION\n");
        my_putstr("    path_file: path to the file we want to compress.\n");
        my_putstr("    type_file: number representing the fyle type.\n");
        my_putstr("        1: text (capable of compressing emojis).\n");
